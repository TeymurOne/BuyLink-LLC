...
export function NewsLetter() {
    ...
    return (
      <section className="lg:py-14 py-7 text-center lg:px-0 px-2 ">
        <h2 className="font-manrope  lg:text-title-xxl text-4xl      leading-8  text-black font-bold">
          {t('letters.0')}{' '}
          <span className="text-starrating mx-2">{t('letters.1')}</span>
        </h2>
        ...
        <div className=" mt-10 space-y-4 lg:space-x-4  space-x-0  px-4">
          <input
            className="border-2 border-opacity-60  pl-3 outline-none  border-searchColor rounded-2xl max-w-125 w-full h-14"
            type="text"
