...
const CardFour = () => {
  ...
  return (
    ...
    <div className="rounded-2xl px-6 pt-4  pb-6    w-full max-w-80   border-black border-opacity-10 border         bg-white    shadow-sm dark:border-strokedark dark:bg-boxdark">
