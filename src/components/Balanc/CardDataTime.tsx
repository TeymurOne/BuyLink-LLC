...
const CardDataTime: React.FC<CardDataTimeProps> = ({
  children,
  title,
  rate,
}) => {
  ...
  const dayOfWeek = new Intl.DateTimeFormat("en-US", { weekday: "long" }).format(week);
  ...
  return (
    <div className="flex space-x-4 pl-4 items-center  py-3 w-full  rounded-xl shadow  dark:bg-boxdark border   bg-transparent border-black  border-opacity-60">
      <div>
        {' '}
        <svg
          width="60"
        ...
        >
          <rect y="0.5" width="60" height="60" rx="30" fill={svgColor} />
          <path
      ...
      <div className="flex flex-col">
        <div className="  text-black font-inter dark:text-white  text-sm   font-semibold">
          {dayOfWeek}, {monthName}
        </div>
