   ...
   {content ? (
    <>
       ...
       <div className="flex justify-between lg:w-1/3 md:w-1/2 py-4 px-3  ">
           ...
           <p className=" font-medium text-black  dark:text-white  ">{content?.id}</p>
         </div>
         ...
         <div className="flex justify-between lg:w-1/3 md:w-1/2 py-4 px-3  ">
          ...
          {t("product.3")}
           ...
           <p className=" font-medium text-black  dark:text-white  ">{content?.title}</p>
         </div>
         <p className="border-b border-stroke  dark:border-strokedark  py-1"></p>
         <div className="flex justify-between lg:w-1/3 md:w-1/2 py-2 px-3  ">
           ...
           <img className="w-20 h-20 rounded-full" src={content?.image} alt="" />
         </div>
         <p className="border-b border-stroke  dark:border-strokedark  py-1"></p>
         <div className="flex justify-between lg:w-1/3 md:w-1/2 py-4 px-3  ">
           <span className=" font-medium text-black dark:text-white  ">
         ...
         <div className="flex justify-between lg:w-1/3 md:w-1/2 py-4 px-3  ">
           ...
           <p className=" font-medium text-black dark:text-white  ">{content?.price}</p>
         </div>
         <div className="flex justify-between lg:w-1/3 md:w-1/2 py-4 px-3  ">
           <span className=" font-medium text-black dark:text-white  ">
           {t("product.6")}
