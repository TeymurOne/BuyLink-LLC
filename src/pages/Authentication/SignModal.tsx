...
const SignModal:React.FC<State> = ({showModal, setShowModal}) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        setLoad(true)
      const userData = await axiosInstance.post('/auth/login', { email, password });
        ...
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto ">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex   max-w-[700px] flex-col  bg-white outline-none focus:outline-none">
                {/*header*/}
