...
const SignIn = () => {
  ...
  return (
    <>
      <div className="rounded-sm border   overflow-y-hidden   border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                ...
                <img
                  className="dark:hidden w-10 rounded-md"
                  src={Logo}
                  alt="Logo"
                />
              </Link>
